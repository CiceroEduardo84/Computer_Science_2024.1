...
# Obter o diretório atual do arquivo principal.py
# diretorio_atual = os.path.dirname(os.path.abspath(__file__))

# Construir o caminho para o arquivo dicionario_pessoas.xls
# caminho_arquivo_excel = os.path.join(diretorio_atual, "dados", "dicionario_pessoas.xls")

# Abrir o arquivo Excel
# planilha = xlrd.open_workbook(caminho_arquivo_excel)
